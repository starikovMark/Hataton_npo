  ...
  <div class="container">
    <div class="hero-wrapper">
      ...
      <div class="hero-text">
        ...
        <a href="./computation.php" class="hero-text-button">Расчитать взнос</a>
      </div>
    </div>
    <!-- /.hero-wrapper -->
  </div>
    ...
    <div class="swiper">
      ...
      <div class="swiper-wrapper">
        ...
        <a href="#" class="swiper-slide">
          <img src="./img/news-1.jpg" alt="News-1" class="swiper-slide-image" />
        ...
        <a href="#" class="swiper-slide">
          <img src="./img/news-2.jpg" alt="News-2" class="swiper-slide-image" />
          <div class="swiper-slide-text">
            <h2 class="swiper-slide-title">
        ...
        <a href="#" class="swiper-slide">
          <img src="./img/news-3.jpg" alt="News-3" class="swiper-slide-image" />
          <div class="swiper-slide-text">
            <h2 class="swiper-slide-title">
        ...
        <a href="#" class="swiper-slide">
          <img src="./img/news-4.webp" alt="News-4" class="swiper-slide-image" />
          <div class="swiper-slide-text">
            <h2 class="swiper-slide-title">
        ...
        <a href="#" class="swiper-slide">
          <img src="./img/news-5.webp" alt="News-5" class="swiper-slide-image" />
          <div class="swiper-slide-text">
            <h2 class="swiper-slide-title">
